export const translations = {
  en: {
    ...
    bundle: {
      one_month: "1 Month Supply",
      two_months: "2 Month Supply",
      three_months: "3 Month Supply",
  ...
  ar: {
      ...
      questions: [
        {
          ...
          answer: "يمكنك شراء ببتيدات الأبحاث مباشرة من Maxa Human. نحن نقدم ببتيدات عالية الجودة تم التحقق منها من قبل المختبر ويتم شحنها مباشرة من منشأتنا السويسرية إلى موقعك."
        },
        {
        ...
        },
        {
          ...
          answer: "ابحث عن الموردين الذين يقدمون اختبارات معملية من طرف ثالث ومصادر شفافة ومعلومات مفصلة عن المنتج. في Maxa Human، نحن نقدم التحقق المستقل من المختبر لجميع منتجاتنا."
        },
        {
    ...
    products: {
      ...
      h1: "اشترِ ببتيدات بحثية أونلاين",
    ...
    footer: {
      ...
      join: "انضم إلى مستقبل علم الأحياء واحصل على خصم 15% + نسخة مجانية من 'دليل ببتيدات Maxa Human' الخاص بنا.",
    ...
    moving_text: {
      stimulating_peptides: "ببتيدات Maxa Human",
      research_grade_peptides: "ببتيدات من الدرجة البحثية"
    },
    instant_authentication: {
      title: "المصادقة الفورية",
      subtitle: "علامة Maxa Human الحقيقية."
    },
    cart: {
      title: "السلة",
