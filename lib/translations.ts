export const translations = {
  en: {
    ...
    product_detail: {
      ...
      low_stock: "Hurry, only 10 items left!",
    ...
    bundle: {
      ...
      gift_bac_water: "Free BAC Water",
      gift_ebook: "Free Peptide Ebook",
      gift_ai_coach: "Free AI Peptide Coach",
  ...
  ar: {
    ...
    product_detail: {
      ...
      low_stock: "بسرعة، باقي 10 قطع فقط!",
    ...
    bundle: {
      one_month: "إمداد شهر",
      two_months: "إمداد شهرين",
      three_months: "إمداد 3 شهور",
      ...
      gift_bac_water: "ماء BAC مجاناً",
      gift_ebook: "كتاب الببتيدات مجاناً",
