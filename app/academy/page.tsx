  ...
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen pt-32">
      <div className="mb-12 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-[#0b182b] mb-4">Peptide Academy</h1>
            ...
            return (
              <Link href={`/academy/${article.slug}`} key={article.id} className="group flex flex-col h-full bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="aspect-[4/3] bg-gray-50 relative overflow-hidden flex items-center justify-center p-8 border-b border-gray-100">
                  <div className="relative w-full h-full flex items-center justify-center">
                    {featuredImage ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-[#f2f6fb] to-[#dde5f0] rounded-xl flex items-center justify-center shadow-inner">
                        <span className="text-[#0b182b] font-bold text-3xl opacity-50">
                  ...
                  {/* CAS Number badge */}
                  {article.cas_number && (
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur text-xs font-bold px-3 py-1.5 rounded-full text-[#0b182b] shadow-sm uppercase tracking-wider">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3 
                    className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#0b182b] transition-colors line-clamp-2" 
                  ...
                  <div className="flex items-center text-[#0b182b] font-semibold text-sm group-hover:gap-2 transition-all mt-auto pt-4 border-t border-gray-50">
